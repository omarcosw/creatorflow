                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                  {filteredRecordings.map(rec => (
                    <div
                      ...
                      className="group relative flex flex-col gap-2.5 p-4 bg-zinc-800/60 border border-zinc-700/40 rounded-2xl hover:border-violet-500/50 transition-all cursor-pointer min-h-[160px]"
                    >
                      {/* Header: icon + delete */}
